                        ...
                        <div class="row align-items__center">
                            <div class="col-md-7 col-sm-7 col-xs-12 col-lg-6">
                                <div class="slide">
                                    ...
                                    <h1>{{$product->name}}</h1>
                                        <div class="cr__btn">
                                            <a href="{{route('product.details',[$product->id])}}">Shop Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6 col-sm-5 col-xs-12 col-md-5">
                                <div class="slide__thumb">
                                    <img src="{{asset('storage/' . $product->image)}}" width="627" height="473" alt="{{$product->name}}">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="category">
                                    <div class="ht__cat__thumb">
                                        <a href="{{route('product.details',[$product->id])}}">
                                            <img src="{{asset('storage/' . $product->image )}}" width="385" height="290" alt="product images">
                                        </a>
                                    </div>
                                    <div class="fr__hover__info">
                                        ...
                                        <button type="submit" class="btn btn-link" style="background:#c43b68"><i class="icon-handbag icons"></i></button>
                                        </form>
                                        </li>

                                            <li><a href="{{route('product.details',[$product->id])}}"><i class="icon-shuffle icons"></i></a></li>
                                        </ul>
                                    </div>
